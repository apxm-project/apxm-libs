...
description: You MUST use this before any creative work - creating features, building components, adding functionality, or modifying behavior. Explores user intent, requirem…
fallback: read upstream/SKILL.md and execute the workflow as written
---

# Brainstorming — obra/superpowers port

This is an APXM-AIR port of the obra/superpowers `brainstorming` skill.
